...
{
    /// <summary>
    /// Reads http requests with image/jpeg content-type and formats them for controllers to use.
    /// In layman's terms: turns http post content into a bitmap and turns a bitmap into http post content.
    /// </summary>
    public class SingleJpegFormatter : BufferedMediaTypeFormatter
    {
        private readonly ILog _log;

        public SingleJpegFormatter(ILog log) : this()
        {
            _log = log;
        }
